...
#ifndef LINT
static char *const _cddbd_h_ident_ = "@(#)$Id: cddbd.h,v 1.53 2006/04/21 19:13:50 megari Exp $";
#endif

/* Here's a "better safe than sorry" style
   definition of INLINE. Should work with
   all compilers, giving a boost with GNU.
*/
#ifndef INLINE
# if __GNUC__
...
#define DF_NOFIX	0x00000080	/* Don't fix entries. */
#define DF_WIN		0x00000100	/* File is a "Windows format" database file. */
...
#define CC_US_ASCII	0x01
#define CC_UTF_8	0x02
#define CC_ISO_8859	0x04
#define CC_UNKNOWN	0x08
...
#define CL_MATCH	2	/* DB checking level for finding matches. */
...
int db_match_chk(db_t *, char *, char *, char **, int);
...
void charset_latin1_ascii(const char *s, char **p);
int charset_utf8_latin1(const char *s, char **p);
int charset_utf8_ascii(const char *s, char **p);
...
/* Other charset functions defined in charset.c. */
